...
export const components: Component[] = [
  ...
  { id: 'shi-r7000-wheel', groupset_id: 'shimano-105-r7000', category: 'wheel', name: 'Mavic Ksyrium SL Laufradsatz', model_number: 'KSYRIUM-SL-HG', price_eur: 699, affiliate_url: affiliateUrl('Mavic+Ksyrium+SL'), freehub_standard: 'hg', description: 'HG-Freilaufkörper für Shimano und SRAM Road 11/12-speed.' },
  ...
  { id: 'sram-rivalaxs-wheel', groupset_id: 'sram-rival-axs', category: 'wheel', name: 'Zipp 303 S Laufradsatz', model_number: 'ZIP-303S-XDR', price_eur: 999, affiliate_url: affiliateUrl('Zipp+303+S'), freehub_standard: 'xdr', description: 'XDR-Freilaufkörper für SRAM AXS Road 12-speed.' },
  ...
  { id: 'campy-chorus12-wheel', groupset_id: 'campagnolo-chorus-12s', category: 'wheel', name: 'Campagnolo Shamal Carbon Laufradsatz', model_number: 'SHAMAL-CARBON-N3W', price_eur: 1299, affiliate_url: affiliateUrl('Campagnolo+Shamal+Carbon'), freehub_standard: 'n3w', description: 'N3W-Freilaufkörper für Campagnolo 12-speed.' },
